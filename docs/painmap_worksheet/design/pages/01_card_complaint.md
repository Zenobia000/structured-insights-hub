...
6. **exit_gate_footer**
   ...
   - section_purpose: 過關條件 checklist + 「儲存並進入卡 2」按鈕；過不了顯示友善阻擋
...
- **#3 Empowerment of Creativity & Feedback（賦權創造）— 主驅動力**
  - 設計手法：
    ...
    - 過關條件清晰可見（exit_gate_footer），使用者能自己判斷「我準備好進下一張了嗎」
...
- **#2 Development & Accomplishment（成就感版）— 副驅動力（限制使用）**
  - 設計手法：
    ...
    - exit_gate_footer 過關條件 checklist — 完成感來自「我做到了過關標準」而非「我得了高分」
