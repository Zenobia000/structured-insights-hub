...
const FULL_CARDS: Array<{ step: number; title: string; body: string }> = [
  { step: 1, title: "抱怨原句", body: "「我每週六晚上要寫 30 則家長 LINE，常寫到半夜兩點，但家長還是覺得我沒講到他孩子的重點。」— 林老師，2026/03/15 補習班下班路上。" },
  { step: 2, title: "3 個有名字的真人", body: "林老師（補習班）、王主任（安親班）、陳老師（家教平台）— 都有 LINE 與電話。" },
  { step: 3, title: "卡關公式", body: "我每次要『寫家長週報』，都會卡在『要兼顧個人化又要快』。" },
  { step: 4, title: "現在怎麼解 + 為什麼還卡", body: "LINE + Excel + 翻聊天記錄。卡在：每個家長要的重點不同，套版會被嫌『沒看我孩子』，全手寫又寫不完。" },
  { step: 5, title: "TRIZ 矛盾選擇", body: "客製化 vs 規模化。為了客製化，犧牲了睡眠與週末。" },
  { step: 6, title: "AI 證據蒐集", body: "Perplexity 撈到 Dcard 補教版 12 篇相關貼文、5 種具體職業（補習班、安親班、家教、線上課老師、學科顧問）都有類似抱怨。" },
  { step: 7, title: "自己先猜 vs AI 對照", body: "猜：最痛是補習班老師。AI 補：安親班輔導老師更頻繁（每天而非每週）。盲點：低估了頻率維度。" },
  { step: 8, title: "訪談計畫", body: "訪 2 位安親班老師。題目：1) 上週六最後一則訊息幾點？2) 為什麼不用現成模板？3) 願意花多少錢解決？" },
  { step: 9, title: "我的判斷", body: "✅ 真痛點。理由：5 種職業有重疊抱怨、有現成 workaround 但仍不滿意、頻率高（每週至少 1 次）。下一步：72 小時內完成 2 場訪談。" },
];
                  ...
                  <dl className="space-y-3">
                    {SUMMARY_ROWS.map(([k, v]) => (
                      <div key={k} className="grid grid-cols-[7rem_1fr] gap-3 text-sm">
                        <dt className="text-text-muted font-medium shrink-0">
                          {k}
                        </dt>
